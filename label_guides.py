...
class LabelGuides(inkex.Effect):
    ...
    def __init__(self):
        ...
        self.arg_parser.add_argument(
                '--preset_tab', default='rrect',
                help='The preset section that is selected (other sections will be ignored)')

        # ROUNDED RECTANGLE PRESET OPTIONS
        self.arg_parser.add_argument(
                '--rrect_preset',default='L7167',
                help='Use the given rounded rectangle preset template')
        self.arg_parser.add_argument(
            '--rrect_radius', type=float, default=1,
                help='Rectangle corner radius')

        # RECTANGULAR PRESET OPTIONS
        self.arg_parser.add_argument(
                '--rect_preset', default='L7784',
                help='Use the given square-corner rectangle template')
        # CIRCULAR PRESET OPTIONS
        self.arg_parser.add_argument('--circ_preset', default='LP2_115R',
                help='Use the given circular template')

        # CUSTOM LABEL OPTIONS
        self.arg_parser.add_argument(
                '--margin_l', type=float, default=8.5,
                help='Left page margin')
        self.arg_parser.add_argument(
                '--margin_t', type=float, default=13,
                help='Top page margin')
        self.arg_parser.add_argument(
                '--size_x', type=float, default=37,
                help='Label X size')
        self.arg_parser.add_argument(
                '--size_y', type=float, default=37,
                help='Label Y size')
        self.arg_parser.add_argument(
                '--pitch_x', type=float, default=39,
                help='Label X pitch')
        self.arg_parser.add_argument(
                '--pitch_y', type=float, default=39,
                help='Label Y pitch')
        self.arg_parser.add_argument(
                '--count_x', type=int,  default=5,
                help='Number of labels across')
        self.arg_parser.add_argument(
                '--count_y', type=int, default=7,
        ...
        self.arg_parser.add_argument(
                '--delete_existing_guides', type=inkex.Boolean, default=False,
                help='Delete existing guides from document')
        self.arg_parser.add_argument(
                '--draw_edge_guides', type=inkex.Boolean, default=True,
                help='Draw guides at label edges')
        self.arg_parser.add_argument(
                '--draw_centre_guides', type=inkex.Boolean, default=True,
                help='Draw guides at label centres')
        self.arg_parser.add_argument(
                '--inset', type=float, default=5,
                help='Inset to use for inset guides')
        self.arg_parser.add_argument(
                '--draw_inset_guides', type=inkex.Boolean, default=True,
                help='Draw guides inset to label edges')
        self.arg_parser.add_argument(
                '--draw_shapes', type=inkex.Boolean, default=True,
                help='Draw label outline shapes')
        self.arg_parser.add_argument(
                '--shape_inset',  default=5,
                help='Inset to use for inset shapes')
        self.arg_parser.add_argument(
                '--draw_inset_shapes', type=inkex.Boolean, default=True,
                help='Draw shapes inset in the label outline')
        self.arg_parser.add_argument(
                '--set_page_size', type=inkex.Boolean, default=True,
